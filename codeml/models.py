...
class BasicClassifier(Model):
    ...
    def __init__(self,
        ...
        if text_field_embedder.get_output_dim() != self._seq2vec_encoder.get_output_dim():
            raise ConfigurationError("The output dimension of the text_field_embedder"
                                     " must match the input dimension of the sequence"
                                     " encoder. Found {} and {},"
        ...
        self._pad = torch.nn.ConstantPad2d((0, 5, 0, 0), 0)
        self._3pad = torch.nn.ConstantPad3d((0, 0, 0, 5, 0, 0), 0)
        initializer(self)
